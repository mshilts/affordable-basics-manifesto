...
- `basic care`: the universal baseline for ordinary outpatient, preventive, maternal, childbirth, postpartum, and core pediatric care
- `earned healthcare continuity insurance`: the work-earned bridge for serious non-basic costs when ordinary coverage fails
